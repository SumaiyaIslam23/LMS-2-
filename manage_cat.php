		...
		<div class="col-md-8">
				...
				<table class="table table-bordered table-hover">
					...
					?>
						<tr>
							...
							<td>
								<button class="btn"><a href="edit_cat.php?cid=<?php echo $row['cat_id']; ?>">Edit</a></button>
								<button class="btn"><a href="delete_cat.php?cid=<?php echo $row['cat_id']; ?>" onclick="return confirm('Are you sure you want to delete this author?');">Delete</a></button>
							</td>
						</tr>
					<?php
					}
			...
			?>
				<table class="table table-bordered table-hover">
					...
					$connection = mysqli_connect("localhost", "root", "");
					$db = mysqli_select_db($connection, "lms");
					$query = "select * from category where cat_name like '%" . $val . "%' ORDER BY cat_id DESC";
					$query_run = mysqli_query($connection, $query);
					while ($row = mysqli_fetch_assoc($query_run)) {
					?>
						<tr>
