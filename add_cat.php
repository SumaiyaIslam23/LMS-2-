	...
	<div class="row">
		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<button type="submit" name="add_cat" class="btn btn-primary" onclick="alertMsg()">Add Category</button>
			</form>
		</div>
		<div class="col-md-4"></div>
	</div>
...
<?php
	if(isset($_POST['add_cat'])) {
		...
		$query_run = mysqli_query($connection, $query);
		// No header redirection here; the alert will handle the navigation.
	}
?>