	...
	<span><marquee>This is library mangement system. Library opens at 8:00 AM and close at 8:00 PM</marquee></span><br><br>
		...
		<div class="row">
					...
					$query = "select * from books  ORDER BY book_id DESC";
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<td><button class="btn" name=""><a href="edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
								<button class="btn"><a href="delete_book.php?bn=<?php echo $row['book_no']; ?>" onclick="return confirm('Are you sure you want to delete this author?');">Delete</a>
							</button></td>
						</tr>
			...
			<form>
					...
					$connection = mysqli_connect("localhost","root","");
					$db = mysqli_select_db($connection,"lms");
					$query = "select * from books where book_name like '%" . $val . "%' ORDER BY book_id DESC";
						$query_run = mysqli_query($connection,$query);
						while ($row = mysqli_fetch_assoc($query_run)){
							?>
							<tr>
