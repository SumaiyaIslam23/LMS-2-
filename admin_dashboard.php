		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-success" href="manage_book.php" target="_blank">View All Books</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-warning" href="manage_cat.php" target="_blank">View Categories</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-primary" href="manage_author.php" target="_blank">View Authors</a>
				</div>
			</div>
		</div>
	</div><br><br>
