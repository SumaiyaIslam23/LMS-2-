	...
	<span><marquee>This is library mangement system. Library opens at 8:00 AM and close at 8:00 PM</marquee></span><br><br>
		...
		<div class="row">
				...
				<form>
					...
					$query = "select * from category  ORDER BY cat_name DESC";
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<td><button class="btn" name=""><a href="edit_cat.php?bn=<?php echo $row['cat_name'];?>">Edit</a></button>
								<button class="btn"><a href="delete_cat.php?bn=<?php echo $row['cat_name']; ?>" onclick="return confirm('Are you sure you want to delete this author?');">Delete</a>
							</button></td>
						</tr>
			...
			<form>
					...
					$connection = mysqli_connect("localhost","root","");
					$db = mysqli_select_db($connection,"lms");
					$query = "select * from category  where cat_name like '%" . $val . "%' ORDER BY cat_name DESC";
						$query_run = mysqli_query($connection,$query);
						while ($row = mysqli_fetch_assoc($query_run)){
							?>
							<tr>
